...
public class DataListenerFailureByRuntimeException extends QueueListenerSync<Data> {
    @Getter
    private int count = 0;

    public DataListenerFailureByRuntimeException(
    ...
    public MessageResult onMessage(final Data item) {
        ...
        throw new RuntimeException("Runtime failure to simulate DLQ");
    }
}
